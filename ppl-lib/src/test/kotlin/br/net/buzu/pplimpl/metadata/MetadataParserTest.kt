...
class MetadataParserTest {
    ...
    @Test
    fun testParseSingle() {
        val metadata = parseMetadata(NAME, GenericMetadataFactory, IndexSequence())
        assertMetadata(metadata, "name", Subtype.STRING, 20, 0, 1)
    }
    ...
    fun testParseComplex() {
        val metadata = parseMetadata( PERSON, GenericMetadataFactory, IndexSequence())
    ...
    fun testParseExtension() {
        val metadata = parseMetadata( EXT, GenericMetadataFactory, IndexSequence())
