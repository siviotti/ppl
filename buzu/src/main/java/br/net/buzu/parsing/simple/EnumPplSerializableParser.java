 ...
 * @since 1.0
 */
public class EnumPplSerializableParser extends AbstractSimpleParser {

	public static final EnumPplSerializableParser INSTANCE = new EnumPplSerializableParser();
