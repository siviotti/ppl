...
import br.net.buzu.metadata.code.CompactMetadataCoder;
import br.net.buzu.metadata.code.NaturalMetadataCoder;
import br.net.buzu.metadata.code.ShortMetadataCoder;
import br.net.buzu.metadata.code.StructuralMetadataCoder;
...
public class BasicCoderManager implements CoderManager {
	...
	public MetadataCoder get(Dialect dialect) {
