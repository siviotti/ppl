...
public enum Dialect {
	...
	/**
	 * <b>DEFAULT DIALECT</b> [Machine Readable] Hides some redundant informations
	...
	public static final Dialect DEFAULT = Dialect.SHORT;

	private final boolean humanReadable;

	private Dialect(boolean humanReadable) {
