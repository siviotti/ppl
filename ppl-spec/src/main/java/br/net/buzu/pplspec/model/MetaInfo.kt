...
@JvmOverloads constructor(parentId: String, val index: Int, val name: String?, subtype: Subtype, size: Int, scale: Int, minOccurs: Int,
                          val maxOccurs: Int, domain: Domain? = null, defaultValue: String? = Syntax.EMPTY, tags: String? = Syntax.EMPTY) : Comparable<MetaInfo> {
    ...
    val isUnbounded: Boolean
        get() = Syntax.UNBOUNDED == maxOccurs
    ...
    init {
        ...
        this.defaultValue = defaultValue ?: Syntax.EMPTY
        this.tags = tags ?: Syntax.EMPTY
