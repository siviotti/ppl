 ...
 * @since 1.0
 */
enum class DataGroup private constructor(private val sizeType: SizeType, private val align: Align, private val fillChar: Char, private val nullChar: Char, val isDelimited: Boolean) {
